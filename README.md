...
- `POST /api/signin` - Autentica um usuário existente (Login).
- `POST /api/logout` - Encerra a sessão do usuário (Logout).
- `GET /api/auth` - Verifica se o usuário está autenticado e retorna seus dados.

### Candidaturas (Job Application)
